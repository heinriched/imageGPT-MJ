...
os.environ["REPLICATE_API_TOKEN"]="r8_GzaFWwebtfmlpqZTyiJeBU8Hmsvosgr0aHly5"
app= Flask(__name__)
...
def index():
    if request.method=="POST":
        ...
        headers = {'Authorization': 'Token r8_GzaFWwebtfmlpqZTyiJeBU8Hmsvosgr0aHly5','Content-Type': 'application/json'}
